		   ...
		   <td>
			<table width="100%" height="350" border="1"  cellpadding="0" cellspacing="0"  bgcolor="#dfeaf1">
				<tr><TD align="center" valign="top" style="padding-left:20px;padding-top:10px;">
					<div align="left">当前位置: <a href="homepage.jsp">首页</a> &gt; <a href="trainManage.jsp">车次信息管理</a> &gt; 火车路线</div>
					<br /><br />
					<H2 style="COLOR: #880000">车次详情</H2> 
				<table border="1" bordercolor="#12A0F5" align=center> 
					<tr>
						<td>火车车次:</td><td style='font-size:18px' width=200>${train.trainid}</td>
					</tr>
					<tr>
						<td>出发地:</td><td>${train.start}</td>
					</tr>
					<tr>
						<td>到达地:</td><td>${train.end}</td>
					</tr>
					<tr>
						<td>行车时间:</td><td>${train.time}</td>
					</tr>
					<tr>
						<td>硬座票价:</td><td>${train.yzprice}</td>
					</tr>
					<tr>
						<td>软座票价:</td><td>${train.rzprice}</td>
					</tr>
					<tr>
						<td>硬卧票价:</td><td>${train.ywprice}</td>
					</tr>
					<tr>
						<td>软卧票价:</td><td>${train.rwprice}</td>
					</tr>
					<tr>
						<!-- 设置当超过宽度时换行 style="WORD-WRAP: break-word" -->
						<td>车辆路线:</td><td style="COLOR: #880000;WORD-WRAP: break-word;" width=200>${train.root}</td>
					</tr>
				</table>
		        <br /><br />												
				</TD></tr>
		 ...
		 <TBODY>
		  <TR><TD style="LINE-HEIGHT: 100%" align="center"> 
		     ...
		     <BR><A href="aboutme.jsp">关于我们</A> | <A href="wzsm.jsp" 
				>网站声明</A> <BR>版权所有&copy;2014-2015 北京邮电大学 罗传炜   <BR>
		      	京ICP备10009636号 </font>
		  </TD></TR>
		  </TBODY>
	 </TABLE>
